...
subscription-required-commentator =
    Для того чтобы воспользоваться всеми возможностями бота 🤖, вам необходимо подписаться на канал
...
server-rent-info =
    🖥️ <b>Аренда сервера</b>

    💰 Цена: <b>{ $price } ₽/месяц</b>
...
server-rent-payment =
    💳 <b>Оплата аренды сервера</b>

    📅 Срок: <b>{ $months_text }</b>
    💰 Сумма: <b>{ $price } ₽</b>
...
tgmaster-pro-buy-info =
    Купить TelegramMaster-PRO.
...
tgmaster-search-gpt-buy-info =
    Купить TelegramMaster_Search_GPT.
...
tgmaster-commentator-buy-info =
    Купить TelegramMaster_Commentator.
...
program-setup-service-info =
    Оплатите услуги по настройке и консультации.
