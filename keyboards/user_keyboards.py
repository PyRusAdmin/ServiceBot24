...
def greeting_keyboards() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text='🔑 Пароль от TelegramMaster-PRO', callback_data='get_password')
            ],
            [
                InlineKeyboardButton(text='🔑 Пароль от TelegramMaster_Commentator',
            ...
            [
                InlineKeyboardButton(text='⚙️ Оплатить настройку ПО',
